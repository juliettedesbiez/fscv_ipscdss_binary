...
Generates (all under {BASE}\\figures_ipsc_binary_17):
  ...
  mlp_saliency.jpg
  feature_importance_rf.jpg
  feature_importance_xgb.jpg

Run after test_models.py.
Usage: python analyse.py [--config fscv_config_ipsc.yaml]
"""
...
# ── MLP ARCHITECTURE (must match train_models.py) ─────────────────────────────
class MLP(nn.Module):
    def __init__(self):
        super().__init__()
